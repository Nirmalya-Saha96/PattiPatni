...
class ApproveMarriageForm extends Component {
  state = {
    adhar_number: '',
    errorMessage: '',
    loading: false
  ...
  onSubmit = async event => {
    ...
    try {
      ...
      await factory.methods.approveMarriage(this.state.adhar_number, this.props.index).send({
        from: accounts[0]
      });
...
export default ApproveMarriageForm;
